...
const Footer = () => {
  return (
    <footer class="px-6 md:px-20 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
    <div class="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div class="md:max-w-96">
            ...
            <p class="mt-6 text-sm">
                ContentAI is a powerful AI content creation platform that helps you generate high-quality content quickly and efficiently. Whether you're a content creator, marketer, or business owner, our platform provides the tools you need to create engaging and effective content.
            </p>
        </div>
    ...
    <p class="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © ContentAI. All Right Reserved.
    </p>
    </footer>
  )
}
